...
public interface FundManagerService {
    ...
    FundManagerCommentDto addComment(@NotBlank String note, @NotNull @Positive Long managerId);

    List<FundManagerCommentDto> listAllComments(@NotNull @Positive Long managerId);
}
